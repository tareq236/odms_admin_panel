  ...
  return (
    <table className="w-full">
        ...
        <tr>
          <th>
            ...
            <div className="flex justify-between items-center gap-5">
              {/* company name */}
              <div>
                <h1 className="h1">Radient Distribution Limited</h1>
            ...
            <article className="grid grid-cols-2 gap-1 mb-3 border-y py-3">
              ...
              <Field fieldName="Designation" fieldInput={daData[0].user_designation} />
              <Field fieldName="Name of Depot" fieldInput={daData[0].user_depot} />
            </article>
          </th>
        </tr>
      </thead>
      ...
      <tfoot>
        <tr>
          <td>
            <div className="flex justify-between gap-5 items-center my-14">
              <div className="border-t border-black min-w-[120px] text-center">
